...
std::vector<SimpleDimensionedValue<double,false,false>::Conv> TimeQuantity::createConversion() const
{
...
TimeQuantity::TimeQuantity():SimpleDimensionedValue<double,false,false>("Time",this->createConversion())
{
    
}
TimeQuantity::TimeQuantity(const double &magnitude,const std::string &unit):SimpleDimensionedValue<double,false,false>("Time",this->createConversion(),magnitude,unit)
{
}
